...
const calander = google.calendar("v3");

/**
 * SCOPES allows you to set access levels; 
 * this is set to read only for now because you don't have access rights to
...
const credentials = {
  ...
  calender_id: process.env.CALENDAR_ID,
  auth_uri: "https://accounts.google.com/o/oauth2/auth",
  token_uri: "https://oauth2.googleapis.com/token",
  auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
  redirect_uris: ["https://SethSingletary.github.io/meet/"],
  javascript_origins: ["https://SethSingletary.github.io", "http://localhost:3000"],
};
